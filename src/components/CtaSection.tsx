        ...
        >
          ...
          <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white mb-6 leading-[1.15] tracking-tight max-w-3xl">
              Ready to put your data to <br className="hidden md:inline" /> work?
            </h2>

            {/* Subtitle */}
            <p className="text-[#cfd9d3] text-sm sm:text-base md:text-lg leading-relaxed max-w-2xl mb-10 opacity-90">
              Tell us about the problem you're solving. We'll bring 40 years of <br className="hidden md:inline" /> combined experience and a partner mindset to the table.
            </p>
