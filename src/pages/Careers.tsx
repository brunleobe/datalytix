    ...
    <div className="bg-white">
      ...
      <div className="bg-slate-50 py-12 border-b border-slate-100">
        <div className="container mx-auto px-4 max-w-7xl flex flex-col md:flex-row items-center justify-between">
          <h1 className="text-2xl font-bold text-slate-800 mb-2 md:mb-0">Careers</h1>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 max-w-7xl py-16">
        <div className="flex flex-col md:flex-row gap-16">
          ...
          <div className="md:w-1/3 text-center md:text-right flex flex-col md:items-end">
            <h2 className="text-2xl font-bold text-slate-800 mb-4 font-serif">Join our team</h2>
            ...
            <div className="mt-8 flex flex-col items-center md:items-end gap-4 text-slate-400">
              <div className="flex items-center gap-3">
                <span className="text-sm">Innovate with data</span>
                <Briefcase size={20} className="text-primary" />
              </div>
              <div className="flex items-center gap-3">
                <span className="text-sm">Grow your career</span>
                <FileText size={20} className="text-primary" />
              </div>
              <div className="flex items-center gap-3">
                <span className="text-sm">Reach out anytime</span>
            ...
            <div className="bg-white border border-slate-100 shadow-sm p-8 rounded-sm">
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {/* First Name */}
                  <div>
                    <label className="block text-xs text-slate-500 mb-2">First Name (required):</label>
                    <input 
                      type="text" 
                      required
                      className="w-full border border-slate-200 p-2.5 text-sm focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors rounded-sm" 
                    />
                  </div>
                  {/* Last Name */}
                  <div>
                    <label className="block text-xs text-slate-500 mb-2">Last Name (required):</label>
                    <input 
                      type="text" 
                      required
                      className="w-full border border-slate-200 p-2.5 text-sm focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors rounded-sm" 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {/* Phone No */}
                  <div>
                    <label className="block text-xs text-slate-500 mb-2">Phone No (required):</label>
                    <input 
                      type="tel" 
                      required
                      className="w-full border border-slate-200 p-2.5 text-sm focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors rounded-sm" 
                  ...
                  {/* Your Email */}
                  <div>
                    <label className="block text-xs text-slate-500 mb-2">Your Email (required):</label>
                    <input 
                      type="email" 
                      required
                      className="w-full border border-slate-200 p-2.5 text-sm focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors rounded-sm" 
